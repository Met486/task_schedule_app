...
class AddDialog2 extends StatelessWidget {
  AddDialog2({Key key, this.editTask}) : super(key: key);
  final Task editTask;
  ...
  void tapAddButton(BuildContext context) {
    final viewModel = Provider.of<TaskViewModel2>(context, listen: false);
